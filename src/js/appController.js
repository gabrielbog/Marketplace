  ...
  function(ko, Context, moduleUtils, KnockoutTemplateUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ResponsiveUtils, ResponsiveKnockoutUtils, ArrayDataProvider) {
     ...
     function ControllerViewModel() {
      ...
      let navData = [
        ...
        { path: 'products', detail: { label: 'Products', iconClass: 'oj-ux-ico-book' } },
        { path: 'statistics', detail: { label: 'Statistics', iconClass: 'oj-ux-ico-bar-chart' } },
        { path: 'create', detail: { label: 'Create', iconClass: 'oj-ux-ico-zoom-in' } },
        { path: 'cart', detail: { label: 'Cart', iconClass: 'oj-ux-ico-cart' } }
      ];
      ...
      this.appName = ko.observable("Marketplace");
